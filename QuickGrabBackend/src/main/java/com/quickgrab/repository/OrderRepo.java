...
public interface OrderRepo extends JpaRepository<OrderModel, Integer> {
	@Query("SELECT new com.quickgrab.dto.RestaurantOrder(o.quantity,o.orderPrice,o.custId, f.foodName,f.foodPrice) from OrderModel o JOIN o.foodModel f where rest_id=?1")
